...
let blobs =
  List.fold all ~init:Map.empty ~f:(fun acc key ->
      let blob =
        ...
        | Monster_horn Gibdo_bone -> [%blob "images/gibdo-bone.png"]
        | Monster_horn Gibdo_wing -> [%blob "images/gibdo-wing.png"]
        | Monster_horn Horriblin_horn -> [%blob "images/horriblin-horn.png"]
        | Monster_horn Aerocuda_wing -> [%blob "images/aerocuda-wing.png"]
        ...
        | Monster_fang Gibdo_guts -> [%blob "images/gibdo-guts.png"]
        | Monster_fang Horriblin_claw -> [%blob "images/horriblin-claw.png"]
        | Monster_fang Aerocuda_eyeball -> [%blob "images/aerocuda-eyeball.png"]
        ...
        | Monster_guts Horriblin_guts -> [%blob "images/horriblin-guts.png"]
